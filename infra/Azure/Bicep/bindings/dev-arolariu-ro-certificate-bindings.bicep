// =====================================================================================
// Development Website SSL Binding - dev.arolariu.ro Certificate Configuration
// =====================================================================================
// This module applies the SSL certificate binding to the dev.arolariu.ro custom
...
// Phase 1 (dev-arolariu-ro-bindings.bicep):
...
//
// Prerequisites:
// - Hostname binding must exist (dev-arolariu-ro-bindings.bicep)
// - Managed certificate must be provisioned
// - Thumbprint must be available
//
// See: bindings/dev-arolariu-ro-bindings.bicep (Phase 1)
// =====================================================================================

targetScope = 'resourceGroup'

metadata description = 'SSL certificate binding for dev.arolariu.ro (Phase 2)'
...
resource devCustomDomainWithSsl 'Microsoft.Web/sites/hostNameBindings@2025-03-01' = {
  parent: devWebsite
