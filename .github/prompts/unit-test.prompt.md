...
### Context Intake
- Inspect implementation and existing tests before writing new cases.
- Read applicable instruction files for framework-specific patterns.
- Consult RFC-guided standards where tests enforce architecture or docs contracts.
