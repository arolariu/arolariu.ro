...
| Effect cleanup | Component-owned listener, observer, timer, subscription, or abort controller is released; reusable lifecycle logic belongs in `react-client-hook` | Relevant component test |
