...
description: Add, correct, or audit source-grounded TypeScript/JSDoc, C#/XML, Python/docstring, README, RFC, operational, reference, example, link, and drift documentation without changing behavior.
---
...
- Adding, correcting, or removing stale JSDoc/TSDoc, C# XML comments, or
  Python/FastAPI docstrings.
...
- RFC 1002 for JSDoc/TSDoc, RFC 2004 for XML documentation, Python guidance
  for docstrings, or the accepted RFC that owns architectural intent.
...
| After selecting a Python/FastAPI public API, model, config helper, or route | [Python docstrings](references/python-docstrings.md) |
...
- JSDoc/TSDoc follows RFC 1002; XML comments follow RFC 2004; Python docstrings
  match the live callable/model/route contract and configured style.
