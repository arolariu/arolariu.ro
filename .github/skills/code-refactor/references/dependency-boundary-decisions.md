...
| Invoices endpoint or worker coordination | Use the current Management entry boundary defined by the [API guide](../../../../sites/api.arolariu.ro/AGENTS.md) and verified by architecture tests | Adapter parameters/fields, service interfaces, constructor tests, DI registration, exception mapping | The move bypasses Invoices Management or needs a new application contract |
