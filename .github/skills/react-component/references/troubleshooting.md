...
| Handler reads old props/state | Callback dependencies, timer/subscription lifetime, functional updates | Add the real dependency, use a functional state update, or keep the latest external payload in the established ref pattern. Do not omit dependencies. |
