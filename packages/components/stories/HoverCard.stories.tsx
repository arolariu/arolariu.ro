...
See the [shadcn/ui Hover Card documentation](https://ui.shadcn.com/docs/components/hover-card) and the [Radix UI Hover Card documentation](https://www.radix-ui.com/primitives/docs/components/hover-card) for more details.
  ...
  argTypes: {
    openDelay: {
      control: "number",
      description: "The duration in milliseconds from when the pointer enters the trigger until the hover card opens.",
      table: {
        type: {summary: "number"},
    ...
    closeDelay: {
      control: "number",
      description: "The duration in milliseconds from when the pointer leaves the trigger or content until the hover card closes.",
      table: {
        type: {summary: "number"},
    ...
    side: {
      ...
      description: "The preferred side of the trigger to render the content relative to.",
      table: {
...
export const Basic: Story = {
  parameters: {
    docs: {
      description: {
        story: "A simple hover card triggered by a link-styled button, showing basic user information.",
      },
    },
  },
  render: () => (
...
export const UserProfile: Story = {
  parameters: {
    docs: {
      description: {
        story: "A more detailed user profile card triggered by a button containing an avatar. Includes stats and join date.",
      },
    },
  },
  render: () => (
        ...
        <div className='flex flex-col gap-4'>
          <div className='flex items-start gap-4'>
            ...
            <div>
              ...
              <div className='text-sm text-neutral-500 dark:text-neutral-400'>@shadcn</div>
              <div className='mt-2 text-sm'>Software developer and creator of UI components</div>
            </div>
          </div>
          <div className='flex gap-4 text-sm'>
            <div>
              <div className='font-medium'>112</div>
              <div className='text-neutral-500 dark:text-neutral-400'>Posts</div>
            </div>
            <div>
...
export const ProductInfo: Story = {
  parameters: {
    docs: {
      description: {
        story: "Displays product or plan details when hovering over a link. Includes features and a call-to-action button.",
      },
    },
  },
  render: () => (
    <HoverCard>
      ...
      <HoverCardContent className='w-80'>
        <div className='space-y-2'>
          ...
          <p className='text-sm'>Our most popular plan, perfect for professionals and small teams.</p>
...
export const ImagePreview: Story = {
  parameters: {
    docs: {
      description: {
        story: "Shows a larger preview of an image when hovering over a thumbnail. Uses a slight open delay.",
      },
    },
  },
  render: () => (
    <HoverCard openDelay={300}>
      ...
      <HoverCardContent className='w-80 p-0'>
        ...
        <div className='p-4'>
          ...
          <p className='text-sm text-neutral-500 dark:text-neutral-400'>Photo by John Smith • 1920×1080</p>
        </div>
      </HoverCardContent>
    </HoverCard>
  ),
...
export const HelpText: Story = {
  parameters: {
    docs: {
      description: {
        story: "Provides contextual help or explanation when hovering over an icon next to a form field or label.",
      },
    },
  },
  render: () => (
      ...
      <HoverCard>
        ...
        <HoverCardContent className='w-80'>
          <div className='space-y-2'>
            ...
            <p className='text-sm'>
              API keys are used to authenticate your requests. Keep your API keys secure and do not share them in publicly accessible areas.
            </p>
            <p className='text-sm'>If you suspect your API key has been compromised, you can regenerate it from your account settings.</p>
            <a
              href='#'
      ...
      <HoverCard>
        ...
        <HoverCardContent>
          <div className='space-y-1'>
            ...
            <p className='text-sm'>This hover card appears below the trigger by default.</p>
          </div>
        </HoverCardContent>
      </HoverCard>
      ...
      <HoverCard>
        ...
        <HoverCardContent side='top'>
          <div className='space-y-1'>
            ...
            <p className='text-sm'>This hover card appears above the trigger element.</p>
          </div>
        </HoverCardContent>
      </HoverCard>
      ...
      <HoverCard>
        ...
        <HoverCardContent
          ...
          <div className='space-y-1'>
            ...
            <p className='text-sm'>This hover card appears to the left of the trigger.</p>
          </div>
        </HoverCardContent>
      </HoverCard>
      ...
      <HoverCard>
        ...
        <HoverCardContent
          ...
          <div className='space-y-1'>
            ...
            <p className='text-sm'>This hover card appears to the right of the trigger.</p>
          </div>
        </HoverCardContent>
      </HoverCard>
    </div>
...
export const CustomTiming: Story = {
  ...
  render: () => (
    <div className='flex gap-8'>
      <div>
        <div className='mb-2 text-center text-sm font-medium'>Quick (100ms)</div>
        <HoverCard
          openDelay={100}
          closeDelay={100}>
          <HoverCardTrigger asChild>
          ...
          <HoverCardContent>
            <div className='space-y-1'>
              ...
              <p className='text-sm'>This card appears and disappears quickly (100ms).</p>
            </div>
          </HoverCardContent>
        </HoverCard>
      </div>
      ...
      <div>
        <div className='mb-2 text-center text-sm font-medium'>Slow (700ms)</div>
        <HoverCard
          openDelay={700}
          closeDelay={700}>
          <HoverCardTrigger asChild>
          ...
          <HoverCardContent>
            <div className='space-y-1'>
              ...
              <p className='text-sm'>This card has a longer delay (700ms) both for appearing and disappearing.</p>
            </div>
          </HoverCardContent>
        </HoverCard>
      </div>
