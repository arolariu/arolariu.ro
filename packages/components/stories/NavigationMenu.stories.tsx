            ...
            <ul className='grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]'>
              <li className='row-span-3'>
                <NavigationMenuLink asChild>
                  <a
                    className='flex h-full w-full flex-col justify-end rounded-md bg-gradient-to-b from-neutral-50 to-neutral-100 p-6 no-underline outline-none select-none focus:shadow-md dark:from-neutral-900 dark:to-neutral-800'
                    href='/'>
...
export const CustomStyled: Story = {
  render: () => (
    <NavigationMenu className='rounded-lg bg-blue-50 p-2 dark:bg-blue-950'>
      <NavigationMenuList>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className='grid w-[400px] gap-3 rounded-lg bg-white p-4 shadow-lg dark:bg-blue-900'>
              <ListItem
                title='Product 1'
                href='#'
        ...
        <NavigationMenuItem>
          <NavigationMenuLink
            href='#'
            className='rounded-md bg-white px-4 py-2 text-blue-700 hover:bg-blue-50 hover:text-blue-800 dark:bg-blue-900 dark:text-blue-100 dark:hover:bg-blue-800'>
            Contact
          </NavigationMenuLink>
        </NavigationMenuItem>
      </NavigationMenuList>
  ...
  render: function MobileFriendlyNavigation() {
    ...
    return (
      <div className='relative'>
        ...
        <NavigationMenu className={cn("transition-all duration-200", isOpen ? "block" : "hidden md:block")}>
          <NavigationMenuList className='flex-col space-y-2 md:flex-row md:space-y-0'>
            <NavigationMenuItem>
              <NavigationMenuLink
                className={navigationMenuTriggerStyle()}
                href='#'>
      ...
      <li>
        <NavigationMenuLink asChild>
          <a
            ref={ref}
            className={cn(
              "block space-y-1 rounded-md p-3 leading-none no-underline transition-colors outline-none select-none hover:bg-neutral-100 focus:bg-neutral-100 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800",
              className,
            )}
            {...props}>
