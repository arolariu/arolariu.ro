...
import {Check, CreditCard, Gift, Heart, HeartCrack, ShoppingCart, ThumbsDown, ThumbsUp, X} from "lucide-react";
      ...
      <div className='flex flex-col items-center gap-4'>
        ...
        {!isComplete ? (
          <FlipButton
            ...
            backIcon={<div className='mr-2 h-4 w-4 animate-spin rounded-full border-2 border-current border-t-transparent' />}
            onClick={handleClick}
            flipped={isPaying}
            disabled={isPaying}
            className='w-40'
      ...
      <div className='flex flex-col items-center gap-6'>
        ...
        {liked !== null && (
          <div className='text-sm text-gray-500'>
            {liked ? "Thanks for your positive feedback!" : "Thanks for your feedback. We'll try to improve."}
          </div>
        )}
      </div>
    );
...
export const MultiState: Story = {
  render: function MultiStateExample() {
    ...
    const states = [
      ...
      {
        label: "Loading",
        icon: <div className='mr-2 h-4 w-4 animate-spin rounded-full border-2 border-current border-t-transparent' />,
      },
