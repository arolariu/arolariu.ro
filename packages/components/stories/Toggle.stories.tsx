...
export const Basic: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "A basic Toggle button with text. Clicking it toggles its pressed state.",
      },
    },
  },
};
...
export const TextFormatting: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Toggle buttons for text formatting options like bold, italic, and underline.",
      },
    },
  },
};
...
export const TextAlignment: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Toggle buttons for text alignment options like left, center, right, and justify.",
      },
    },
  },
};
...
export const CustomStyling: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Examples of Toggle buttons with custom styling for different actions.",
      },
    },
  },
};
...
export const ToggleGroupExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Examples of grouped Toggle buttons for notifications and view options.",
      },
    },
  },
};
