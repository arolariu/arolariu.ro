      ...
      <Sheet>
        ...
        <SheetContent>
          <SheetHeader>
            ...
            <SheetDescription>
              The default sheet size for side sheets.
            </SheetDescription>
          </SheetHeader>
          <div className="py-4">
            <p>
              This is the standard sheet size that works well for most use
              cases.
            </p>
          </div>
        </SheetContent>
      ...
      <Sheet>
        ...
        <SheetContent className="sm:max-w-[300px]">
          <SheetHeader>
            ...
            <SheetDescription>
              A smaller sheet for simpler content.
            </SheetDescription>
          </SheetHeader>
          <div className="py-4">
      ...
      <Sheet>
        ...
        <SheetContent className="sm:max-w-[540px]">
          <SheetHeader>
            ...
            <SheetDescription>
              A larger sheet for more complex content.
            </SheetDescription>
          </SheetHeader>
          <div className="py-4">
            <p>
              This size is suitable for more complex forms or detailed
              information that requires more horizontal space.
            </p>
          </div>
        </SheetContent>
      </Sheet>
      ...
      <Sheet>
        ...
        <SheetContent className="sm:max-w-full">
          <SheetHeader>
            ...
            <SheetDescription>
              A sheet that takes the full width of the screen.
            </SheetDescription>
          </SheetHeader>
          <div className="py-4">
...
export const CustomStyled: Story = {
  ...
  render: () => (
    <Sheet>
      ...
      <SheetContent className="border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50 dark:border-blue-900">
        <SheetHeader>
          <SheetTitle className="text-blue-700 dark:text-blue-300">
            Custom Styled Sheet
          </SheetTitle>
        ...
        <div className="py-4 text-blue-700 dark:text-blue-300">
          <p>
            This sheet demonstrates custom background colors, text colors, and
            border colors.
          </p>
          <p className="mt-2">
            You can customize every aspect of the sheet to match your
