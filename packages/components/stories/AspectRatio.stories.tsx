...
export const Landscape: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Displays content with a 16:9 (standard landscape) aspect ratio.",
      },
    },
  },
  render: (args) => (
...
export const WithContent: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Demonstrates using AspectRatio with non-image content, like a styled div.",
      },
    },
  },
  render: (args) => (
    <div className='w-[300px]'>
      <AspectRatio {...args}>
        <div className='flex h-full w-full items-center justify-center rounded-md bg-neutral-100 dark:bg-neutral-800'>
...
export const Comparison: Story = {
  parameters: {
    docs: {
      description: {
        story: "Compares the visual output of several common aspect ratios side-by-side.",
      },
    },
  },
  render: () => (
    <div className='space-y-4'>
      <div>
        <p className='mb-1 text-sm font-medium'>Square (1:1)</p>
      ...
      <div>
        <p className='mb-1 text-sm font-medium'>Landscape (16:9)</p>
        <div className='w-full max-w-[200px]'>
      ...
      <div>
        <p className='mb-1 text-sm font-medium'>Portrait (3:4)</p>
      ...
      <div>
        <p className='mb-1 text-sm font-medium'>Ultrawide (21:9)</p>
