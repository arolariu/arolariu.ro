...
See the [shadcn/ui Drawer documentation](https://ui.shadcn.com/docs/components/drawer) and the [Vaul documentation](https://vaul.emilkowal.ski/) for more details.
  ...
  argTypes: {
    ...
    shouldScaleBackground: {
      control: "boolean",
      description: "Whether the background should scale down when the drawer is open.",
      table: {
...
export const Bottom: Story = {
  parameters: {
    docs: {
      description: {
        story: "The default drawer behavior, sliding up from the bottom. Ideal for mobile interfaces.",
      },
    },
  },
  render: () => (
    <Drawer>
      ...
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>This is a drawer component that slides up from the bottom of the screen.</DrawerDescription>
        </DrawerHeader>
        <div className='p-4'>
          <p className='text-muted-foreground text-sm'>
            Drawers are perfect for mobile interfaces when you need contextual actions or information without navigating to a new page.
          </p>
        </div>
        <DrawerFooter>
...
export const Top: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "A drawer sliding down from the top, useful for notifications or quick settings.",
      },
    },
  },
  render: (args) => (
    <Drawer {...args}>
      ...
      <DrawerContent>
        ...
        <div className='p-4'>
          <p className='text-muted-foreground text-sm'>Top drawers can be useful for notifications, filters, or quick actions.</p>
        </div>
        <DrawerFooter>
          <DrawerClose asChild>
            <Button>Close</Button>
...
export const Left: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "A drawer sliding in from the left, commonly used for side navigation menus.",
      },
    },
  },
  render: (args) => (
    <Drawer {...args}>
      ...
      <DrawerContent>
        ...
        <div className='p-4'>
          <p className='text-muted-foreground text-sm'>Left drawers are commonly used for navigation menus in responsive layouts.</p>
          <div className='mt-4 space-y-1'>
            <div className='cursor-pointer rounded px-2 py-1 hover:bg-neutral-100 dark:hover:bg-neutral-800'>Dashboard</div>
            <div className='cursor-pointer rounded px-2 py-1 hover:bg-neutral-100 dark:hover:bg-neutral-800'>Profile</div>
            <div className='cursor-pointer rounded px-2 py-1 hover:bg-neutral-100 dark:hover:bg-neutral-800'>Settings</div>
            <div className='cursor-pointer rounded px-2 py-1 hover:bg-neutral-100 dark:hover:bg-neutral-800'>Help & Support</div>
          </div>
        </div>
        <DrawerFooter>
          <DrawerClose asChild>
...
export const Right: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "A drawer sliding in from the right, suitable for context panels or details.",
      },
    },
  },
  render: (args) => (
    <Drawer {...args}>
      ...
      <DrawerContent>
        ...
        <div className='p-4'>
          <p className='text-muted-foreground text-sm'>
            Right drawers can be used for supplementary information, user profiles, or settings panels.
          </p>
        </div>
        <DrawerFooter>
          <DrawerClose asChild>
...
export const WithForm: Story = {
  parameters: {
    docs: {
      description: {
        story: "Demonstrates embedding a form within a drawer for tasks like editing profiles.",
      },
    },
  },
  render: () => (
...
export const NestedDrawers: Story = {
  parameters: {
    docs: {
      description: {
        story: "Shows how drawers can be nested within each other, useful for multi-step processes or hierarchical information.",
      },
    },
  },
  render: () => (
    <Drawer>
      ...
      <DrawerContent>
        ...
        <div className='p-4'>
          <p className='text-muted-foreground mb-4 text-sm'>Click the button below to open a nested drawer.</p>
          <Drawer>
            <DrawerTrigger asChild>
            ...
            <DrawerContent>
              ...
              <div className='p-4'>
                <p className='text-muted-foreground text-sm'>
                  Nested drawers can be useful for progressive disclosure of information or multi-step forms.
                </p>
              </div>
              <DrawerFooter>
                <DrawerClose asChild>
      ...
      <DrawerContent className='max-h-[85vh] sm:max-w-md'>
        <div className='bg-primary p-6'>
          <div className='flex items-center justify-between'>
            ...
            <DrawerClose className='bg-primary-foreground/10 hover:bg-primary-foreground/20 rounded-full p-1'>
              <svg
                width='18'
                height='18'
                viewBox='0 0 24 24'
              ...
              <div
                ...
                <div className='flex items-center space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-muted-foreground text-sm'>Small / Black</p>
                    <div className='mt-1 flex items-center space-x-2'>
                      <button className='inline-flex h-5 w-5 items-center justify-center rounded-full border'>-</button>
                ...
                <div className='text-right'>
                  ...
                  <button className='text-muted-foreground hover:text-destructive ml-2 text-sm'>
                    <svg
                      width='14'
                      height='14'
                      viewBox='0 0 24 24'
