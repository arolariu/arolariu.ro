...
See the [shadcn/ui Dialog documentation](https://ui.shadcn.com/docs/components/dialog) and the [Radix UI Dialog documentation](https://www.radix-ui.com/primitives/docs/components/dialog) for more details.
  ...
  argTypes: {
    ...
    modal: {
      control: "boolean",
      description: "When true, interaction with outside elements is disabled and focus is trapped within the dialog.",
      table: {
    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>This is a basic dialog component with a title and description.</DialogDescription>
        </DialogHeader>
        <p className='py-4'>Dialog content goes here. This can include any content you want to show in your dialog.</p>
      </DialogContent>
    </Dialog>
  ),
};
...
export const WithForm: Story = {
  parameters: {
    docs: {
      description: {
        story: "Demonstrates embedding a form within a dialog, including input fields, labels, and a save button in the footer.",
      },
    },
  },
  render: () => (
...
export const CustomStyled: Story = {
  parameters: {
    docs: {
      description: {
        story: "Shows how to apply custom styles to the DialogTrigger and DialogContent using CSS classes for branding or theming.",
      },
    },
  },
  render: () => (
    <Dialog>
      ...
      <DialogContent className='border-blue-200 bg-gradient-to-br from-purple-50 to-blue-50'>
        <DialogHeader>
          <DialogTitle className='text-blue-700'>Custom Styled Dialog</DialogTitle>
