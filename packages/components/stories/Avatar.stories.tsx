...
export const WithImage: Story = {
  parameters: {
    docs: {
      description: {
        story: "A standard avatar displaying an image. If the image loads successfully, the fallback is hidden.",
      },
    },
  },
  render: () => (
...
export const CustomStyled: Story = {
  parameters: {
    docs: {
      description: {
        story: "Shows how to apply custom styles, like borders or background/text colors for the fallback, using CSS classes.",
      },
    },
  },
  render: () => (
    <div className='flex items-center gap-4'>
      ...
      <Avatar className='border-2 border-amber-500'>
        <AvatarFallback className='bg-amber-100 text-amber-800'>EF</AvatarFallback>
      </Avatar>
    </div>
  ),
};
...
export const FallbackVariants: Story = {
  parameters: {
    docs: {
      description: {
        story: "The \`AvatarFallback\` can contain various types of content, such as text, initials, or even icons.",
      },
    },
  },
  render: () => (
