...
export const Basic: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "A basic Select dropdown with several options. The selected value is displayed on the trigger button.",
      },
    },
  },
  render: () => (
...
export const WithGroups: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Shows how to group related options within the Select dropdown using `SelectGroup` and `SelectLabel`.",
      },
    },
  },
  render: () => (
...
export const Disabled: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "A Select component that is disabled, preventing the user from opening the dropdown or changing the selection.",
      },
    },
  },
  render: () => (
...
export const WithDisabledItems: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Shows a Select dropdown where specific options are disabled and cannot be selected.",
      },
    },
  },
  render: () => (
...
export const WithLabel: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates how to use a standard HTML label with the Select component.",
      },
    },
  },
  render: () => (
