...
/// <para><b>Confidentiality:</b> Implementations MUST NOT log prompt or response content, since <see cref="GenerativeRequest.UserPayload"/>
/// may carry OCR-derived personal or sensitive data.</para>
/// </remarks>
public interface IGenerativeAiBroker
{
  /// <summary>
  ...
  Task<GenerativeResponse<T>> GenerateStructuredAsync<T>(
