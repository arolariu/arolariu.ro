...
public sealed partial class AzureDocumentIntelligenceBroker
{
  internal static DocumentIntelligenceRecord MapDocumentIntelligenceRecord(AnalyzedDocument analyzedDocument)
  {
