...
{
    internal static List<ChatMessage> CreateContextListForInvoiceDescription() =>
        new List<ChatMessage>()
        {
            new ChatMessage(
                ChatRole.System,
                @"You are a specialized AI assistant that has immense knowledge of the food industry. You are an expert at identifying products bought from stores. You will be tasked with generating a fun and friendly short text about the bought products from an invoice. You need to respect the user prompt and ONLY respond back with what the user requests. There is no need to offer more context or additional phrasing - as your responses need to be short and succint. Here are some examples of interactions with the user:"),
            new ChatMessage(
                ChatRole.User,
                @"This invoice consists of the following items:
    ...
    internal static List<ChatMessage> CreateContextListForRecipes() =>
        new List<ChatMessage>()
        {
    ...
    internal static List<ChatMessage> CreateContextListForAllergens() =>
        new List<ChatMessage>()
        {
    ...
    internal static List<ChatMessage> CreateContextListForSurvivalFact() =>
        new List<ChatMessage>()
        {
    ...
    internal static List<ChatMessage> CreateContextListForProductGenericName() =>
        new List<ChatMessage>()
        {
            new ChatMessage(ChatRole.System, @"You are a specialized AI assistant that has immense knowledge of the food industry. You are an expert at identifying products bought from stores. You will be tasked with different tasks from this domain area. You need to respect the user prompt and ONLY respond back with what the user requests. There is no need to offer more context or additional phrasing - as your responses need to be short and succint. Here are some examples of interactions with the user:"),
    ...
    internal static List<ChatMessage> CreateContextListForProductCategory() =>
        new List<ChatMessage>()
        {
    ...
    internal static void ConfigureChatOptions(ChatCompletionsOptions options,
        float temperature, int tokens, int frequencyPenalty, int presencePenalty, int choices)
    {
        options.Temperature = temperature;
        options.MaxTokens = tokens;
        options.FrequencyPenalty = frequencyPenalty;
        options.PresencePenalty = presencePenalty;
        options.ChoiceCount = choices;
    }
}
