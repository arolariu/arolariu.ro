...
/// <summary>
/// This class represents the CRUD processing service.
/// </summary>
public partial class CrudProcessingService : ICrudProcessingService
{
  ...
  private readonly ILogger<ICrudProcessingService> logger;
    ...
    ILoggerFactory loggerFactory)
  {
    ...
    logger = loggerFactory.CreateLogger<ICrudProcessingService>();
  }
