...
/// <para><b>Deliberately excluded:</b> Analysis artifacts (<see cref="Product.Classification"/> and
/// allergen assessment) and user workflow flags are NOT set here. Extraction knows nothing
