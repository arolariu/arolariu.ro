...
/// prompt/policy problem, a spike in schema violations is a model/contract problem &#8212; so the provider boundary
/// stamps refusals with a domain-owned marker that every service layer can inspect without a reverse dependency.</para>
