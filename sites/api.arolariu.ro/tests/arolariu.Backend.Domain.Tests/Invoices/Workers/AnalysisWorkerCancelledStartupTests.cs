...
public sealed class AnalysisWorkerCancelledStartupTests
{
  ...
  /// </summary>
  private sealed class CountingAnalysisProcessingService : IAnalysisProcessingService
  {
  ...
  /// </summary>
  private sealed class CancellingEnsureStoreProcessingService(CancellationTokenSource shutdownSource) : IAnalysisProcessingService
  {
    private int tryExecuteCalls;
