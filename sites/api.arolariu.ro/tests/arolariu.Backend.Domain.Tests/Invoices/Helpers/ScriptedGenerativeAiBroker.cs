...
internal sealed class ScriptedGenerativeAnalysisBroker : IGenerativeAnalysisBroker
{
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="ScriptedGenerativeAnalysisBroker"/> class.
  /// </summary>
  /// <param name="scriptedResponses">The scripted responses returned in call order.</param>
  public ScriptedGenerativeAnalysisBroker(params ScriptedGenerativeResponse[] scriptedResponses)
  {
