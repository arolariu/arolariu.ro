...
public static class TaxonomyBrokerTestFactory
{
  ...
  public static ITaxonomyBroker Create() =>
    new JsonTaxonomyBroker(CreateArtifactJsonBySystem());
  ...
  public static ITaxonomyBroker CreateLargeEcoicopBroker(int nodeCount)
  {
    ...
    var artifactJsonBySystem = new Dictionary<ClassificationSystem, string>(CreateArtifactJsonBySystem())
    {
      [ClassificationSystem.EcoicopV2] = artifactJson
    };

    return new JsonTaxonomyBroker(artifactJsonBySystem);
  }

  internal static IReadOnlyDictionary<ClassificationSystem, string> CreateArtifactJsonBySystem() =>
    new Dictionary<ClassificationSystem, string>
    {
      [ClassificationSystem.EcoicopV2] = CreateEcoicopArtifactJson(),
      [ClassificationSystem.Nace21] = CreateNaceArtifactJson(),
      [ClassificationSystem.Gs1Gpc] = CreateGs1ArtifactJson()
    };

  internal static IReadOnlyDictionary<ClassificationSystem, string> CreateArtifactJsonBySystemWithEmptyNodes(
    ClassificationSystem system)
  {
    var artifactJsonBySystem = new Dictionary<ClassificationSystem, string>(CreateArtifactJsonBySystem());

    artifactJsonBySystem[system] = system switch
    {
      ClassificationSystem.EcoicopV2 => CreateArtifactJson(
        system: "ECOICOP_V2",
        version: "2",
        sourceUrl: "https://example.test/ecoicop",
        attribution: "Test ECOICOP artifact",
        nodes: []),
      ClassificationSystem.Nace21 => CreateArtifactJson(
        system: "NACE_2_1",
        version: "2.1",
        sourceUrl: "https://example.test/nace",
        attribution: "Test NACE artifact",
        nodes: []),
      ClassificationSystem.Gs1Gpc => CreateArtifactJson(
        system: "GS1_GPC",
        version: "2026-05",
        sourceUrl: "https://example.test/gpc",
        attribution: "Test GPC artifact",
        nodes: []),
      _ => artifactJsonBySystem[system]
    };

    return artifactJsonBySystem;
  }

  private static string CreateEcoicopArtifactJson() =>
    """
    {
      "system": "ECOICOP_V2",
      "version": "2",
  ...
  private static string CreateNaceArtifactJson() =>
    """
    {
      "system": "NACE_2_1",
      "version": "2.1",
  ...
  private static string CreateGs1ArtifactJson() =>
    """
    {
      "system": "GS1_GPC",
      "version": "2026-05",
