...
public sealed class GenerativeClassificationTests
{
  ...
  {
    var broker = new ScriptedGenerativeAnalysisBroker(
      ScriptedGenerativeAnalysisBroker.Failure(new RequestFailedException(400, "content_filter")));
  ...
  {
    var broker = new ScriptedGenerativeAnalysisBroker(
      ScriptedGenerativeAnalysisBroker.Failure(new InvalidStructuredOutputException("Provider did not return a typed structured result.")));
  ...
  public async Task ClassifyProductsAsync_CancellationRequested_PropagatesWithoutRetry()
  {
    ...
    var broker = new ScriptedGenerativeAnalysisBroker(
      ScriptedGenerativeAnalysisBroker.Failure(new TaskCanceledException()));
