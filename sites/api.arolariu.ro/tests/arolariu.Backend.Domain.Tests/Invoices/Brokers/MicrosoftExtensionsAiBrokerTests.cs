...
/// <summary>
/// Defines materialization tests for the real <see cref="MicrosoftExtensionsAiBroker"/> driven over a deterministic
...
/// </remarks>
[TestClass]
public sealed class MicrosoftExtensionsAiBrokerTests
{
  /// <summary>
  ...
  public async Task GenerateStructuredAsync_PrivateNestedOutputContract_MaterializesTypedResult()
  {
    ...
    var broker = new MicrosoftExtensionsAiBroker(chatClient);
