...
export default async function Footer() {
	return (
		<footer className="relative bottom-0 mt-16 w-full bg-indigo-500">
			<svg
			...
			<div className="mx-auto px-4 pt-12 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
				<div className="row-gap-10 mb-8 grid gap-16 lg:grid-cols-6">
					...
					<div className="row-gap-8 grid grid-cols-2 gap-5 md:grid-cols-4 lg:col-span-4">
						<div>
							<p className="text-teal-accent-400 font-semibold tracking-wide">Domain Services</p>
							<ul className="mt-2 space-y-2">
								<li>
									<Link
										href="https://arolariu.ro/domains/invoices"
										className="tooltip tooltip-top text-purple-50 transition-colors duration-300 hover:text-teal-400"
								...
								<li>
									<Link
										href="https://arolariu.ro/domains/links"
										className="text-deep-purple-50 hover:text-teal-accent-400 tooltip transition-colors duration-300"
						...
						<div>
							<p className="text-teal-accent-400 font-semibold tracking-wide">Libraries</p>
							<ul className="mt-2 space-y-2">
								<li>
									<a
										href="/"
						...
						<div>
							<p className="text-teal-accent-400 font-semibold tracking-wide">Other Projects</p>
							<ul className="mt-2 space-y-2">
								<li>
									<a
										href="/"
						...
						<div>
							<p className="text-teal-accent-400 font-semibold tracking-wide">About</p>
							<ul className="mt-2 space-y-2">
								<li>
									<a
										href="/"
				...
				<div className="border-deep-purple-accent-200 flex flex-col justify-between border-t pb-10 pt-5 sm:flex-row">
					<p className="text-sm text-gray-100">
						© Copyright 2023 Alexandru-Razvan Olariu. <br />
						<span className="ml-4">
