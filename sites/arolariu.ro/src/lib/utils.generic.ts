 ...
 *   uploadedBy: "user-123",
 * };
 * const blobMetadata = writeBlobMetadata(metadata);
 * ```
 */
 ...
 * @throws When required fields are missing or enum/date values are invalid.
 *
 * @example
 * ```typescript
 * const blobMetadata = {
 ...
 *   uploadedBy: "user-123",
 * };
 * const metadata = readBlobMetadata(blobMetadata);
 * ```
 */
