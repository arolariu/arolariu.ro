    ...
    <section style={{display: 'flex', flexDirection: 'column', gap: '1.5rem'}}>
      ...
      <div style={{display: 'grid', gridTemplateColumns: '1fr', gap: '1rem'}}>
        ...
        <div style={{borderRadius: '0.75rem', border: '1px solid #e5e7eb', padding: '1.25rem', gridColumn: 'span 2'}}>
          ...
          <div style={{marginTop: '0.75rem', borderRadius: '0.375rem', border: '1px solid #e5e7eb', paddingLeft: '0.75rem', paddingRight: '0.75rem', paddingTop: '0.5rem', paddingBottom: '0.5rem', fontSize: '0.875rem'}}>GPT-4o</div>
        ...
        <div style={{borderRadius: '0.75rem', border: '1px solid #e5e7eb', padding: '1.25rem'}}>
          ...
          <div style={{marginTop: '0.75rem', borderRadius: '0.375rem', border: '1px solid #e5e7eb', paddingLeft: '0.75rem', paddingRight: '0.75rem', paddingTop: '0.5rem', paddingBottom: '0.5rem', fontSize: '0.875rem'}}>Detailed</div>
          ...
          <div style={{marginTop: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.75rem'}}>
            {[
              ...
              <div
                ...
                <div style={{height: '1.25rem', width: '2.25rem', borderRadius: '9999px', backgroundColor: f.enabled ? '#2563eb' : '#e5e7eb'}} />
              </div>
            ))}
          </div>
        </div>
