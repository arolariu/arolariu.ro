    ...
    <section style={{display: 'flex', flexDirection: 'column', gap: '1.5rem'}}>
      ...
      <div style={{display: 'grid', gridTemplateColumns: '1fr', gap: '1rem'}}>
        ...
        <div style={{borderRadius: '0.75rem', border: '1px solid #e5e7eb', padding: '1.25rem'}}>
          ...
          <div style={{marginTop: '0.75rem', display: 'flex', gap: '0.5rem'}}>
            <button style={{flex: '1', borderRadius: '0.375rem', backgroundColor: '#111827', paddingLeft: '0.75rem', paddingRight: '0.75rem', paddingTop: '0.375rem', paddingBottom: '0.375rem', fontSize: '0.875rem', color: '#ffffff'}}>
              Normal
            </button>
            <button style={{flex: '1', borderRadius: '0.375rem', border: '1px solid #e5e7eb', paddingLeft: '0.75rem', paddingRight: '0.75rem', paddingTop: '0.375rem', paddingBottom: '0.375rem', fontSize: '0.875rem'}}>Dyslexic</button>
          </div>
        ...
        <div style={{borderRadius: '0.75rem', border: '1px solid #e5e7eb', padding: '1.25rem'}}>
          ...
          <div style={{marginTop: '0.75rem', borderRadius: '0.375rem', border: '1px solid #e5e7eb', paddingLeft: '0.75rem', paddingRight: '0.75rem', paddingTop: '0.5rem', paddingBottom: '0.5rem', fontSize: '0.875rem'}}>English (EN)</div>
        </div>
