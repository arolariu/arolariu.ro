 ...
 * @module app/domains/invoices/_actions/invoices/scans/detachScanFromInvoice
 *
 * @remarks
...
/**
 * Input parameters for the detachScanFromInvoice server action.
 *
 * @remarks
...
/**
 * Output result type for the detachScanFromInvoice server action.
 *
 * @remarks
 ...
 * - `api.actions.invoices.detachScanFromInvoice` - Parent span
 ...
 * @example
 * ```typescript
 * import { detachScanFromInvoice } from "@/app/domains/invoices/_actions/invoices/scans/detachScanFromInvoice";
 *
 * // Delete a scan from an invoice
 * const result = await detachScanFromInvoice({
