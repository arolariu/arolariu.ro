 ...
 *
 * The actual component depends on `useDialog` context, server actions for
 * patching invoice visibility, and clipboard APIs, so this story renders
 * a faithful HTML replica of the initial sharing mode selection screen.
 */
const meta = {
