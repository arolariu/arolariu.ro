 ...
 *
 * The actual component depends on `useDialog` context, Zustand stores,
 * and server actions, so this story renders a faithful HTML replica
 * of the confirmation dialog with impact summary.
 */
const meta = {
  ...
  render: () => (
    <div className='rounded-xl border bg-white shadow-xl dark:border-gray-700 dark:bg-gray-900'>
      ...
      <div className='flex justify-end gap-2 border-t p-4'>
        ...
        <button className='flex items-center gap-2 rounded-md bg-red-600 px-4 py-2 text-sm text-white opacity-50' disabled>
