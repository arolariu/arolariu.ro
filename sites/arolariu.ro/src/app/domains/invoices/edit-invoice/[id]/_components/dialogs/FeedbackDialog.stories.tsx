          ...
          <div style={{display: "flex", gap: "0.25rem"}}>
            {[1, 2, 3, 4, 5].map((star) => (
              <button
                ...
                <TbStar
                  style={{height: "1.5rem", width: "1.5rem", ...(star <= 3 ? {fill: "#facc15", color: "#facc15"} : {color: "#d1d5db"})}}
                />
              </button>
            ))}
          </div>
              ...
              (feature) => (
                <span
                  ...
                  style={{
                    ...
                    fontSize: "0.75rem",
                    ...(feature === "Spending Trends" || feature === "Visual Charts" ? {backgroundColor: "#111827", color: "#fff"} : {}),
                  }}>
                  {feature}
                </span>
              ),
