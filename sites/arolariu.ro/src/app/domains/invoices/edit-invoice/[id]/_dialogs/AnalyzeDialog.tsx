...
export default function AnalyzeDialog(): React.JSX.Element {
  ...
  const selectedConfig = analysisOptions.find((option) => option.id === selectedOption);
  ...
  }, [invoice, selectedConfig, selectedEnhancements, selectedOption, close, t]);
