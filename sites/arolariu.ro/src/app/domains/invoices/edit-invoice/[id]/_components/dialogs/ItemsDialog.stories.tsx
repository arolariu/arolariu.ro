 ...
 *
 * The actual component depends on `useDialog` context, pagination hooks,
 * and editable item state, so this story renders a faithful HTML replica
 * of the items editing table with sample line items.
 */
const meta = {
