    ...
    <div style={{borderRadius:"0.75rem", border:"1px solid #e5e7eb", backgroundColor:"#fff", boxShadow:"0 20px 25px -5px rgba(0,0,0,.1),0 8px 10px -6px rgba(0,0,0,.1)"}}>
      ...
      <div style={{padding:"1.5rem"}}>
          ...
          <table style={{minWidth:"100%"}}>
            <thead>
              <tr style={{backgroundColor:"#f9fafb"}}>
                <th style={{paddingInline:"1rem", paddingBlock:"0.75rem", textAlign:"left", fontSize:"0.75rem", fontWeight:500, letterSpacing:"0.05em", color:"#6b7280", textTransform:"uppercase"}}>Item</th>
                <th style={{paddingInline:"1rem", paddingBlock:"0.75rem", textAlign:"center", fontSize:"0.75rem", fontWeight:500, letterSpacing:"0.05em", color:"#6b7280", textTransform:"uppercase"}}>Qty</th>
                <th style={{paddingInline:"1rem", paddingBlock:"0.75rem", textAlign:"center", fontSize:"0.75rem", fontWeight:500, letterSpacing:"0.05em", color:"#6b7280", textTransform:"uppercase"}}>Unit</th>
                <th style={{paddingInline:"1rem", paddingBlock:"0.75rem", textAlign:"right", fontSize:"0.75rem", fontWeight:500, letterSpacing:"0.05em", color:"#6b7280", textTransform:"uppercase"}}>Price</th>
                <th style={{paddingInline:"1rem", paddingBlock:"0.75rem", textAlign:"right", fontSize:"0.75rem", fontWeight:500, letterSpacing:"0.05em", color:"#6b7280", textTransform:"uppercase"}}>Total</th>
                <th style={{paddingInline:"1rem", paddingBlock:"0.75rem", textAlign:"center", fontSize:"0.75rem", fontWeight:500, letterSpacing:"0.05em", color:"#6b7280", textTransform:"uppercase"}}>Actions</th>
              </tr>
            </thead>
            <tbody style={{backgroundColor:"#fff"}}>
              {sampleItems.map((item) => (
                <tr
                  ...
                  <td style={{paddingInline:"1rem", paddingBlock:"0.75rem", textAlign:"right", fontSize:"0.875rem"}}>{item.price.toFixed(2)}</td>
                  <td style={{paddingInline:"1rem", paddingBlock:"0.75rem", textAlign:"right", fontSize:"0.875rem", fontWeight:500}}>{item.total.toFixed(2)}</td>
        ...
        <div style={{marginTop:"1rem", display:"flex", alignItems:"center", justifyContent:"space-between"}}>
          <button style={{display:"flex", alignItems:"center", gap:"0.25rem", borderRadius:"0.375rem", border:"1px solid #e5e7eb", paddingInline:"0.75rem", paddingBlock:"0.375rem", fontSize:"0.875rem"}}>
