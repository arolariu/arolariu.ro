 ...
 *
 * The actual component depends on `usePaginationWithSearch`, `useWindowSize`,
 * and complex table/grid sub-components, so this story renders
 * a faithful HTML replica of the toolbar and placeholder content area.
 */
const meta = {
