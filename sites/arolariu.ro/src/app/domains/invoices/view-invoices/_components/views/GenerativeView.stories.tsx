  ...
  render: () => (
    <div style={{display: 'flex', flexDirection: 'column', gap: '1rem'}}>
      ...
      <div style={{display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between'}}>
        ...
        <button style={{display: 'flex', alignItems: 'center', gap: '0.25rem', borderRadius: '0.375rem', border: '1px solid #e5e7eb', padding: '0.375rem 0.75rem', fontSize: '0.875rem'}}>
      ...
      <div style={{display: 'flex', gap: '0.25rem', borderRadius: '0.5rem', backgroundColor: '#f3f4f6', padding: '0.25rem'}}>
        <button style={{display: 'flex', alignItems: 'center', gap: '0.5rem', borderRadius: '0.375rem', backgroundColor: '#ffffff', padding: '0.375rem 1rem', fontSize: '0.875rem', fontWeight: 500, boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)'}}>
          <TbMessage style={{height: '1rem', width: '1rem'}} />
          <span>Chat</span>
        </button>
        <button style={{display: 'flex', alignItems: 'center', gap: '0.5rem', borderRadius: '0.375rem', padding: '0.375rem 1rem', fontSize: '0.875rem', color: '#6b7280'}}>
        ...
        <div style={{padding: '1rem'}}>
          <div style={{display: 'flex', flexDirection: 'column', gap: '1rem'}}>
            ...
            <div style={{display: 'flex', gap: '0.75rem'}}>
              <div style={{display: 'flex', height: '2rem', width: '2rem', flexShrink: 0, alignItems: 'center', justifyContent: 'center', borderRadius: '9999px', backgroundColor: '#f3e8ff', fontSize: '0.875rem'}}>
                🤖
              </div>
