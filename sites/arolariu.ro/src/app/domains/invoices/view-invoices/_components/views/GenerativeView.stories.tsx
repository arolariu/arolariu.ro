 ...
 *
 * The actual component uses complex state, MessageList sub-component,
 * and invoice data, so this story renders a faithful HTML replica
 * of the chat UI including tabs and settings panel.
 */
const meta = {
