...
import fetchInvoicesForUser from "@/lib/fetchInvoicesForUser";
...
export default async function RenderViewInvoicesPage({session}: Props) {
	const invoices = await fetchInvoicesForUser(session.user as User);
	// TODO: add auth from FE and pass it to this custom hook. Hook must forward FE auth to BE for auth + retrieval
		...
		<div className="container px-5 py-24 mx-auto">
			<div className="flex flex-col w-full mb-20 text-center">
				...
				<p className="mx-auto text-base leading-relaxed lg:w-2/3">
					This is your digital receipts inventory. <br /> Here you can find the receipts that
					you&apos;ve uploaded so far. <br />
					...
					<section className="dark:text-white">
						<div className="container px-5 pb-6 mx-auto">
							<div className="flex flex-wrap -m-4 text-center">
								...
								<div className="w-1/2 p-4 sm:w-1/4">
									<h2 className="text-3xl font-medium title-font sm:text-4xl">
										{calculateNumberOfProductsBought()}
									</h2>
