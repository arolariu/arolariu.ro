      ...
      <section className='dark:text-gray-200'>
        <div className='container mx-auto flex flex-col items-center justify-center px-5 py-24'>
          ...
          <div className='mt-2 w-full text-center lg:w-2/3'>
            <h1 className='title-font mb-4 bg-gradient-to-r from-pink-400 to-red-600 bg-clip-text text-3xl font-medium text-transparent sm:text-4xl'>
            ...
            <p className='mb-8 leading-relaxed'>
              ...
              somewhere, and get powerful insights into your habits? What if you could automatically get a list of all
            ...
            <div className='md:w-1/2 md:py-6 md:pr-10 lg:w-2/5'>
              <div className='relative flex pb-12'>
                ...
                <div className='flex-grow pl-4'>
                  ...
                  <p className='leading-relaxed'>
                    Create an account so that you can store your own receipts securely onto our platform. We adhere to
                    the industry standards in terms of security. Your receipt information is{" "}
                    <strong
              ...
              <div className='relative flex pb-12'>
                ...
                <div className='flex-grow pl-4'>
                  ...
                  <p className='leading-relaxed'>
                    Upload your paper receipt. The system will then perform the full analysis. We try as much as
                    possible to have a fully automated process, but sometimes we may need your help.
                  </p>
                </div>
              </div>
              <div className='relative flex pb-12'>
                ...
                <div className='flex-grow pl-4'>
                  ...
                  <p className='leading-relaxed'>
                    Delve into the analysis provided by us. You can download the full analysis report as a PDF file for
                    your own records.
                  </p>
                </div>
              </div>
