							...
							<div className='flex items-center gap-3'>
								...
								<div>
									<p className='font-semibold text-purple-900 dark:text-purple-100'>
										{selectedScans.length} {selectedScans.length > 1 ? t("sidebar.selectionStatus.plural") : t("sidebar.selectionStatus.singular")}
									</p>
									<p className='text-sm text-purple-700 dark:text-purple-300'>
										{selectedScans.length > 1
											? t("sidebar.selectionStatus.readyPlural")
											: t("sidebar.selectionStatus.readySingular")}
									</p>
								</div>
							</div>
						</CardContent>
