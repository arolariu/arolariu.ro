 ...
 * @remarks
 * **Behavior contract:**
 * - `rotate(direction)` executes the following pipeline:
 ...
 * return (
 *   <>
 *     <button onClick={() => rotation.rotate("cw")} disabled={rotation.isRotating}>
 *       Rotate Right
 *     </button>
 *     <button onClick={() => rotation.rotate("ccw")} disabled={rotation.isRotating}>
 *       Rotate Left
 *     </button>
 ...
 * ```
 */
export function useScanRotation(scan: CachedScan): UseScanRotationOutput {
