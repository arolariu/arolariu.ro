 ...
 *
 * The actual component is a switch statement that renders different dialogs
 * based on the `useDialogs` context state. This story shows a schematic
 * overview of all dialog types the container can render.
 */
const meta = {
