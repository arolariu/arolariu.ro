...
const meta = {
  title: "arolariu.ro/IMS/Components/Scan/ScanMediaPreview",
...
/** Wide image aspect ratio — landscape orientation. */
export const WideImage: Story = {
  args: {
    src: storyImageScanUrl,
    mediaKind: "image",
    alt: "Wide landscape receipt scan",
    loading: "eager",
  },
  parameters: {
    docs: {
      description: {
        story: "Preview with wide landscape image. Tests aspect ratio handling and layout with horizontal receipts or invoices.",
      },
    },
  },
};

/** Tall image aspect ratio — portrait orientation. */
export const TallImage: Story = {
  args: {
    src: storyImageScanUrl,
    mediaKind: "image",
    alt: "Tall portrait receipt scan",
    loading: "eager",
  },
  parameters: {
    docs: {
      description: {
        story: "Preview with tall portrait image. Tests aspect ratio handling and layout with vertical receipts.",
      },
    },
  },
};
