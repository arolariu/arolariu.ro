  ...
  render: () => (
    <div style={{borderRadius:'0.75rem', border:'1px solid #e5e7eb', padding:'1.25rem'}}>
      ...
      <div style={{display:'flex', flexDirection:'column', gap:'0.75rem'}}>
        ...
        <div style={{display:'grid', gridTemplateColumns:'repeat(3, minmax(0, 1fr))', gap:'0.5rem', textAlign:'center', fontSize:'0.75rem'}}>
      ...
      <div style={{display:'flex', flexDirection:'column', gap:'0.75rem'}}>
        ...
        <div style={{display:'flex', gap:'0.5rem'}}>
          {["Grocery", "Dining", "Home"].map((cat) => (
            <button
              key={cat}
              style={{borderRadius:'9999px', border:'1px solid #e5e7eb', paddingLeft:'0.75rem', paddingRight:'0.75rem', paddingTop:'0.25rem', paddingBottom:'0.25rem', fontSize:'0.75rem'}}>
              {cat}
            </button>
          ))}
        </div>
