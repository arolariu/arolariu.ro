 ...
 *
 * The actual component depends on `useInvoiceContext` for recipes and
 * metadata, so this story renders a faithful HTML replica showing the
 * "Possible Recipes" and "Additional Info" tabs.
 */
const meta = {
