 ...
 *
 * The actual component depends on `useInvoiceContext`, `useDialog`,
 * and `useUserInformation`, so this story renders a faithful HTML
 * replica showing shared users with avatars, email actions, and a
