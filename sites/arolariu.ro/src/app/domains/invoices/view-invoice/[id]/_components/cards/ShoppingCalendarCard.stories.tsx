      ...
      <div className="flex flex-col items-center space-y-4 p-4">
        ...
        <div className="grid w-full grid-cols-7 gap-1 rounded-md border p-3 dark:border-gray-700">
          ...
          {Array.from({length: 31}, (_, i) => {
            ...
            const bgClasses = ["bg-transparent", "bg-green-100 dark:bg-green-900/30", "bg-green-200 dark:bg-green-800/40", "bg-green-400 dark:bg-green-600/50", "bg-green-600 text-white dark:bg-green-500"];
            return (
              <div
                key={`day-${String(i)}`}
