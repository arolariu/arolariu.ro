 ...
 *
 * The actual component depends on `useInvoiceContext` and `useDialog`,
 * so this story renders a faithful HTML replica of the visual structure
 * with mock timeline data and sharing information.
 */
const meta = {
