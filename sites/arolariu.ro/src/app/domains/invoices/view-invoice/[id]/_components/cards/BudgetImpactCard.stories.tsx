  ...
  render: () => (
    <div style={{borderRadius: '0.5rem', border: '1px solid #e5e7eb', backgroundColor: '#fff', boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)'}}>
      <div style={{borderBottom: '1px solid #e5e7eb', padding: '1rem'}}>
        <h3 style={{display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1.125rem', fontWeight: 600}}>💳 Budget Impact — January</h3>
      </div>
      <div style={{display: 'flex', flexDirection: 'column', gap: '1rem', padding: '1rem'}}>
        <div>
          ...
          <div style={{marginTop: '0.5rem', height: '0.75rem', width: '100%', overflow: 'hidden', borderRadius: '9999px', backgroundColor: '#e5e7eb'}}>
            <div
              style={{height: '100%', borderRadius: '9999px', backgroundColor: '#2563eb', width: '45%'}}
            />
          </div>
...
export const OverBudget: Story = {
  render: () => (
    <div style={{borderRadius: '0.5rem', border: '1px solid #e5e7eb', backgroundColor: '#fff', boxShadow: '0 1px 2px 0 rgba(0,0,0,0.05)'}}>
      <div style={{borderBottom: '1px solid #e5e7eb', padding: '1rem'}}>
        <h3 style={{display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1.125rem', fontWeight: 600}}>💳 Budget Impact — December</h3>
      </div>
      <div style={{display: 'flex', flexDirection: 'column', gap: '1rem', padding: '1rem'}}>
        <div>
          <div style={{display: 'flex', justifyContent: 'space-between', fontSize: '0.875rem'}}>
          ...
          <div style={{marginTop: '0.5rem', height: '0.75rem', width: '100%', overflow: 'hidden', borderRadius: '9999px', backgroundColor: '#e5e7eb'}}>
            <div
              style={{height: '100%', borderRadius: '9999px', backgroundColor: '#ef4444', width: '100%'}}
            />
          </div>
          <div style={{marginTop: '0.25rem', display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem', color: '#6b7280'}}>
