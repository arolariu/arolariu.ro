 ...
 *
 * The actual component depends on `useInvoiceContext`, `useUserInformation`,
 * and several analytics utility functions, so this story renders a faithful
 * HTML replica of the analytics dashboard with summary stats and chart placeholders.
 */
const meta = {
