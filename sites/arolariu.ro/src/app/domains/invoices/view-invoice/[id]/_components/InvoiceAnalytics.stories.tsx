          ...
          <div style={{display: "flex", flexDirection: "column", gap: "0.5rem"}}>
            {[
              ...
              <div key={cat.name}>
                ...
                <div
                  style={{marginTop: "0.25rem", height: "0.5rem", overflow: "hidden", borderRadius: "9999px", backgroundColor: "#f3f4f6"}}>
                  <div style={{height: "100%", borderRadius: "9999px", backgroundColor: cat.color, width: `${String(cat.pct)}%`}} />
                </div>
              </div>
            ))}
          </div>
