  ...
  render: () => (
    <div className="rounded-lg border bg-white shadow-sm dark:bg-gray-900">
      ...
      <div className="space-y-4 p-4">
        ...
        <div>
          <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-gray-500">Auto-Detected Category</p>
        ...
        {/* Budget Impact */}
        <div>
          <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-gray-500">Budget Impact</p>
