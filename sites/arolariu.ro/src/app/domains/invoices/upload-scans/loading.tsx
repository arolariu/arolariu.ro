...
/**
 * Skeleton placeholder for the upload-scans page while `page.tsx` resolves auth.
 *
 * @remarks
 * Mirrors the real layout 1:1 (breadcrumb, 3-step workflow progress, header,
 * content grid with dropzone + sidebar of 3 cards) to avoid layout shift. Static
 * HTML + CSS only; the workflow nav is `aria-hidden` since it is non-interactive.
 *
 * @returns The upload-scans loading skeleton.
 */
