			...
			<section className="text-white">
				<div className="container px-5 pt-24 mx-auto">
					<div className="flex flex-col w-full mb-20 text-center">
                        ...
                        <p>The <code>arolariu.ro</code> story began in 2022, when the author - Alexandru-Razvan Olariu, wanted to understand how websites work.</p>
                        <p>The whole platform and underlying integrations have been developed solely by the author, from what he has learnt along the years.</p>
                        <br/><p>Alexandru currently works as a software engineer at Microsoft. To learn more about him, check the right section of this page.</p>
                        <p>The platform is built using the latest state-of-the-art technologies. To learn more about it, check the left section of this page.</p>
					</div>
				</div>
			</section>
					...
					<div className="flex flex-wrap mb-10 text-center">
						<div className="px-8 sm:w-1/2">
							...
							<p className="text-base leading-relaxed">
								...
								experience for all of the applications and OSS projects that the author{" "}
								<em>(Alexandru-Razvan Olariu)</em> is working on. <br />
								<br />
						...
						<div className="px-8 sm:w-1/2">
							...
							<p className="text-base leading-relaxed">
								<code>arolariu</code> is the alias/nickname of the author: Alexandru-Razvan Olariu. <br /> Alexandru is
								a well-tenured software engineer, solution architect and lifelong learner. <br />
								<br />
