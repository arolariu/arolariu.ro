...
const contactLinks = [
  {
    ...
    icon: <TbMail className={styles["linkIcon"]} />,
  ...
  },
  {
    ...
    icon: <TbBrandLinkedin className={styles["linkIcon"]} />,
  ...
  },
  {
    id: "github",
    label: "/arolariu",
    icon: <TbBrandGithub className={styles["linkIcon"]} />,
  ...
  },
  {
    id: "website",
    label: "arolariu.ro",
    icon: <TbWorld className={styles["linkIcon"]} />,
