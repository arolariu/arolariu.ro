                  ...
                  <div className={styles["cardContentInner"]}>
                    <div className={styles["cardTextCenter"]}>
                      <h3 className={styles["cardTitle"]}>
                        {t(selectorFromPath(`About.Hub.navigation.${`${item.key}.title` as "platform.title"}`))}
                      </h3>
                      <p className={styles["cardSubtitle"]}>
                        {t(selectorFromPath(`About.Hub.navigation.${`${item.key}.subtitle` as "platform.subtitle"}`))}
                      </p>
                    </div>
