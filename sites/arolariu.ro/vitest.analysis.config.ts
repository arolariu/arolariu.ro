...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "sites/arolariu.ro/src/app/domains/invoices/_components/analysis/StructuredAnalysisDetails.test.tsx",
      "sites/arolariu.ro/src/app/domains/invoices/_utils/classificationUtilities.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/view-invoices/_utils/filterOptions.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/view-invoices/_utils/statistics.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/view-invoices/_hooks/useFilteredInvoices.test.tsx",
      ...
      "sites/arolariu.ro/src/app/domains/invoices/_actions/invoices/fetchInvoices.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/invoices/deleteInvoice.test.ts",
      ...
      "sites/arolariu.ro/src/app/domains/invoices/_actions/invoices/products/deleteInvoiceProduct.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/invoices/products/updateInvoiceProduct.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/invoices/scans/attachScanToInvoice.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/scans/createScan.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/scans/fetchScans.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/scans/updateScan.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/scans/createScanUploadTarget.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/invoices/scans/attachScanToInvoice.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_hooks/product/useProductAdd.test.tsx",
      "sites/arolariu.ro/src/app/domains/invoices/_hooks/product/useProductRemove.test.tsx",
      "sites/arolariu.ro/src/lib/azure/storageClient.test.ts",
      "sites/arolariu.ro/src/lib/azure/storageLocationPolicy.test.ts",
      "sites/arolariu.ro/src/lib/telemetry/logSanitizer.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/merchants/fetchMerchant.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_actions/merchants/fetchMerchants.test.ts",
      ...
      "sites/arolariu.ro/src/app/domains/invoices/create-invoice/_context/CreateInvoiceContext.classification.test.ts",
      ...
      "sites/arolariu.ro/src/app/domains/invoices/edit-invoice/[id]/_dialogs/ClassificationPersistenceDialogs.test.tsx",
      "sites/arolariu.ro/src/app/domains/invoices/edit-invoice/[id]/_dialogs/ItemsDialog.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/_utils/mimeTypeUtilities.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/upload-scans/_intake/validation.test.ts",
      "sites/arolariu.ro/src/app/domains/invoices/view-invoice/[id]/_components/cards/AnalysisPanel.test.tsx",
      "sites/arolariu.ro/src/app/domains/invoices/view-invoice/[id]/_components/export/InvoicePDF.test.tsx",
      ...
      "sites/arolariu.ro/src/stores/merchantsStore.test.tsx",
    ],
