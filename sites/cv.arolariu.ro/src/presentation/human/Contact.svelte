...
<section id="contact" class="py-16 px-6 relative overflow-hidden">
	...
	<div class="container mx-auto relative z-10">
		<AnimatedSection id="contact-title" animation="fade-up">
		...
		<div class="max-w-6xl mx-auto">
			<div class="grid md:grid-cols-2 gap-12">
				<!-- Contact Information -->
				<AnimatedSection id="contact-info" animation="fade-right" delay={200}>
					<div
						class="backdrop-blur-sm rounded-xl p-8 shadow-lg transition-all duration-300 bg-white/80 dark:bg-black/40"
					>
				...
				<!-- Contact Form -->
				<AnimatedSection id="contact-form" animation="fade-left" delay={400}>
					<div
						class="backdrop-blur-sm rounded-xl p-8 shadow-lg transition-all duration-300 bg-white/80 dark:bg-black/40"
					>
