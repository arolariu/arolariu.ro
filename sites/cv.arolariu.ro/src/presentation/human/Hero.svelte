...
<section class="pt-24 pb-16 px-6 relative overflow-hidden">
	...
	<div class="container mx-auto text-center relative z-10">
		...
		<div
			class="transition-all duration-800 {heroVisible
		...
		<div
			class="transition-all duration-800 delay-300 {heroVisible
				? 'opacity-100 translate-y-0'
				: 'opacity-0 translate-y-8'}"
		>
			<p class="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-6">
				Software Engineer | Solution Architect | Mentor
			</p>
		</div>

		<div
			class="transition-all duration-800 delay-500 {heroVisible
				? 'opacity-100 translate-y-0'
				: 'opacity-0 translate-y-8'}"
		>
			<p class="text-lg text-gray-500 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
				{new Date().getFullYear() - 2000}-year-old passionate software engineer based in {author.location},
				dedicated to creating innovative solutions and building exceptional digital experiences.
			</p>
		</div>
