...
<section id="experience" class="py-16 px-6 relative overflow-hidden">
	...
	<div class="container mx-auto relative z-10">
		<AnimatedSection id="experience-title" animation="fade-up">
			<div class="mb-12 text-center">
				<h2 id="experience-heading" class="font-bold text-3xl">
		...
		<div class="max-w-6xl mx-auto">
			<div class="space-y-8">
				{#each experiencesAsArray as experience, index}
					<AnimatedSection id="experience-{index}" animation="fade-up" delay={index * 200}>
						<div
								...
								<div class="mb-6">
									...
									<ul class="space-y-2 stagger-animation">
										{#each parseList(experience.responsibilities) as item, i}
											<li class="flex items-start" style={`--delay:${index * 200 + i * 90}ms`}>
												<span class="mr-3 mt-1 text-sm font-medium text-blue-500 dark:text-blue-400"
													>▶</span
												>
												<span
								...
								<div class="mb-6">
									...
									<ul class="space-y-2 stagger-animation">
										{#each parseList(experience.achievements) as item, i}
											...
											>
												<span
													class="mr-3 mt-1 text-sm font-medium text-green-500 dark:text-green-400"
													>✓</span
												>
												<span
													class="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-200"
