...
export const experiences: Experiences = {
	microsoft3: {
		...
		description:
			'Alexandru is currently working at Microsoft as a software engineer in the E+D MSAI (M365 AI Experiences) organization.',
		techAndSkills:
	...
	microsoft1: {
		...
		techAndSkills:
			'Network Traffic Analysis # Azure # Customer-centric Approach # Business Relationships # Incident Manager',
		responsibilities:
	...
	ubisoft: {
		...
		techAndSkills:
			'Unit Testing # Integration Testing # A/B Testing # Performance Testing # Automatic Testing # E2E Testing',
		responsibilities:
	...
	intel: {
		...
		techAndSkills:
			'C # C++ # Intel x8086 Assembly # Color Space Converters # Python # Embedded Compute # Internet of Things',
		responsibilities:
