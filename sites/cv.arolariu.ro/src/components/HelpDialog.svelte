	...
	>
		...
		>
					...
					<tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-gray-50 dark:bg-gray-900">
						<tr>
							<th
								...
								>{ui.labels.version}</th
							>
							<td
								class="px-3 xsm:px-4 sm:px-6 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300"
							>
								<span
									class="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300 rounded-md font-mono"
			...
			<section class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
				...
				<div
					class="grid grid-cols-1 xsm:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3"
				>
					{#each techInfo.dependencies as dep}
						<div
							class="rounded-lg p-2 sm:p-3 text-center border bg-gray-100 dark:bg-gray-800 border-gray-200 dark:border-gray-700"
						>
